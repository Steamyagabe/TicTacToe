...
class TicTacToe:
    def __init__(self, game):
        self.game = game
        self.field_image = self.get_scaled_image(path='Spritelarım/field.png', res=[WIN_SIZE] * 2)
        self.O_image = self.get_scaled_image(path='Spritelarım/o.png', res=[CELL_SIZE] * 2)
        self.X_image = self.get_scaled_image(path='Spritelarım/x.png', res=[CELL_SIZE] * 2)
